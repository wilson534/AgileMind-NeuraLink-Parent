...
const DailyReportPage = () => {
    ...
    const getEmotionType = (report) => {
        ...
        if (score >= 70)
            return 'neutral';
        if (score >= 60)
            return 'neutral'; // 将'calm'改为'neutral'，与EmotionFace组件兼容
        if (score >= 50)
            return 'worried';
        if (score >= 40)
            return 'angry';
    ...
    return (_jsxs(PageContainer, { children: [_jsx(Title, { children: "\u6BCF\u65E5\u60C5\u7EEA\u62A5\u544A" }), _jsx(Description, { children: "\u4E86\u89E3\u5B69\u5B50\u7684\u60C5\u7EEA\u53D8\u5316\uFF0C\u53CA\u65F6\u7ED9\u4E88\u5173\u7231\u548C\u652F\u6301" }), _jsxs(TimeRangeContainer, { children: [_jsx(TimeRangeButton, { "$isActive": timeRange === '3days', onClick: () => handleTimeRangeChange('3days'), children: "\u6700\u8FD1\u4E09\u5929" }), _jsx(TimeRangeButton, { "$isActive": timeRange === '7days', onClick: () => handleTimeRangeChange('7days'), children: "\u6700\u8FD1\u4E03\u5929" }), _jsx(TimeRangeButton, { "$isActive": timeRange === '30days', onClick: () => handleTimeRangeChange('30days'), children: "\u6700\u8FD1\u4E09\u5341\u5929" }), _jsx(TimeRangeButton, { "$isActive": timeRange === 'custom', onClick: () => handleTimeRangeChange('custom'), children: "\u81EA\u5B9A\u4E49\u65F6\u95F4" })] }), timeRange === 'custom' && (_jsxs(DateInputContainer, { children: [_jsx(DateInput, { type: "date", value: startDate, onChange: (e) => setStartDate(e.target.value) }), _jsx("span", { children: "\u81F3" }), _jsx(DateInput, { type: "date", value: endDate, onChange: (e) => setEndDate(e.target.value) }), _jsx(ApplyButton, { onClick: handleCustomDateApply, children: "\u5E94\u7528" })] })), _jsxs(FilterContainer, { children: [_jsx(FilterButton, { "$isActive": filter === 'latest', onClick: () => setFilter('latest'), children: "\u5168\u90E8\u62A5\u544A" }), _jsx(FilterButton, { "$isActive": filter === 'positive', onClick: () => setFilter('positive'), children: "\u79EF\u6781\u60C5\u7EEA" }), _jsx(FilterButton, { "$isActive": filter === 'attention', onClick: () => setFilter('attention'), children: "\u9700\u8981\u5173\u6CE8" })] }), _jsx(ReportsContainer, { children: filteredReports.map(report => (_jsxs(ReportCard, { onClick: () => handleCardClick(report), initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.3 }, whileHover: { y: -5 }, children: [_jsxs(ReportHeader, { "$emotionColor": getEmotionColor(report), children: [_jsx(ReportDate, { children: report.date }), _jsx(ReportSummary, { children: report.summary })] }), _jsxs(ReportContent, { children: [_jsxs(EmotionScore, { children: [_jsx(ScoreLabel, { children: "\u60C5\u7EEA\u6307\u6570" }), _jsx(ScoreValue, { children: report.emotionScore })] }), _jsx(EmotionTags, { children: report.emotionTags.map((tag, index) => (_jsx(EmotionTag, { "$color": tag.color, children: tag.name }, index))) })] })] }, report.id))) }), expandedReport && (_jsx(ExpandedCard, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, onClick: handleCloseExpanded, children: _jsxs(ExpandedCardContent, { onClick: (e) => e.stopPropagation(), initial: { scale: 0.9, opacity: 0 }, animate: { scale: 1, opacity: 1 }, transition: { type: 'spring', damping: 20 }, children: [_jsxs(ExpandedHeader, { "$emotionColor": getEmotionColor(expandedReport), children: [_jsx(ReportDate, { children: expandedReport.date }), _jsx(ReportSummary, { children: expandedReport.summary }), _jsx(CloseButton, { onClick: handleCloseExpanded, children: "\u00D7" })] }), _jsxs(ExpandedContent, { children: [_jsx(EmotionFace, { emotionType: getEmotionType(expandedReport), color: getEmotionColor(expandedReport) }), _jsxs(EmotionScore, { children: [_jsx(ScoreLabel, { children: "\u60C5\u7EEA\u6307\u6570" }), _jsx(ScoreValue, { children: expandedReport.emotionScore })] }), _jsx(EmotionTags, { children: expandedReport.emotionTags.map((tag, index) => (_jsx(EmotionTag, { "$color": tag.color, children: tag.name }, index))) }), expandedReport.emotionDistribution && (_jsx(EmotionDistribution, { emotions: expandedReport.emotionDistribution })), _jsxs(AnalysisSection, { children: [_jsx(SectionTitle, { children: "\u8BE6\u7EC6\u5206\u6790" }), _jsx(AnalysisText, { children: expandedReport.analysis })] }), _jsxs(AnalysisSection, { children: [_jsx(SectionTitle, { children: "\u5EFA\u8BAE" }), _jsx(SuggestionList, { children: expandedReport.suggestions.map((suggestion, index) => (_jsx(SuggestionItem, { children: suggestion }, index))) })] }), _jsxs(ActionButtons, { children: [_jsxs(ActionButton, { children: [_jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.42 4.42 3 7.5 3C9.24 3 10.91 3.81 12 5.09C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.42 22 8.5C22 12.28 18.6 15.36 13.45 20.04L12 21.35Z", fill: "currentColor" }) }), "\u70B9\u8D5E"] }), _jsxs(ActionButton, { children: [_jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M18 16.08C17.24 16.08 16.56 16.38 16.04 16.85L8.91 12.7C8.96 12.47 9 12.24 9 12C9 11.76 8.96 11.53 8.91 11.3L15.96 7.19C16.5 7.69 17.21 8 18 8C19.66 8 21 6.66 21 5C21 3.34 19.66 2 18 2C16.34 2 15 3.34 15 5C15 5.24 15.04 5.47 15.09 5.7L8.04 9.81C7.5 9.31 6.79 9 6 9C4.34 9 3 10.34 3 12C3 13.66 4.34 15 6 15C6.79 15 7.5 14.69 8.04 14.19L15.16 18.35C15.11 18.56 15.08 18.78 15.08 19C15.08 20.61 16.39 21.92 18 21.92C19.61 21.92 20.92 20.61 20.92 19C20.92 17.39 19.61 16.08 18 16.08Z", fill: "currentColor" }) }), "\u5206\u4EAB"] }), _jsxs(ActionButton, { children: [_jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { d: "M19 9H15V3H9V9H5L12 16L19 9ZM5 18V20H19V18H5Z", fill: "currentColor" }) }), "\u4E0B\u8F7D"] })] })] })] }) }))] }));
};
